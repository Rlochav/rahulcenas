...
.profile {
	...
	overflow: hidden;
	margin: 0 auto;
	background: url(../profileImage?image=${profileInfo.profilePic})
...
<body ng-controller="AppController">
	<input type="hidden" id="timelineId" value="${profileInfo.timelineId}">
			...
			<div class="row">
					...
					<div class="left-section">
						<div class="profile">
							<span class="fa fa-user fa-5x"></span> <span class="profile-name"><a href="#"
								class="color-white" data-toggle="modal" data-target="#myModal">${profileInfo.firstName}</a></span>
						</div>
						<div class="panel panel-default mar-top-10">
							<div class="panel-heading">Current Account type</div>
						...
						<div class="panel panel-default mar-top-10">
							<div class="panel-heading">Upgrade account Type</div>
							<div class="panel-body">
								<ul class="list-block">
					...
					<div class="post-section">
						<form role="form" name="statusForm" ng-submit="doPost();" class="simple-form" novalidate>
							<div class="update-status">
								...
								<span class="text-danger" ng-show="submitted && statusForm.statusText.$error.required">Post
									cann't be empty.</span>
							</div>
							<div class="update-status" ng-hide="hideThumbnail">
								<div ng-repeat="item in uploader.queue">
									<div id="canvas" ng-show="uploader.isHTML5" ng-thumb="{ file: item._file, height: 100 }"
				...
				<div class="col-md-3 col-sm-12 col-xs-12">
					...
					<div class="recent-post-section">
						<div class="market-report-tbl bu-as panel-default">
							<div class="panel-heading">Sports You Like</div>
						...
						<div class="market-report-tbl bu-as panel-default">
							<div class="panel-heading">Celebrities You May Follow</div>
							<table border="0" cellpadding="0" cellspacing="0" class="table table-condensed">
								<tbody>
									<tr>
										<td class="bg-white"><span>68468</span></td>
