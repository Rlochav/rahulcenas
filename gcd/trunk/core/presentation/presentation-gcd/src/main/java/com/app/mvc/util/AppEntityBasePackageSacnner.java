...
public class AppEntityBasePackageSacnner implements ApplicationContextAware, PersistenceUnitPostProcessor {
		...
		if (this.packagesToScan != null) {
			try {
				for (String pkg : this.packagesToScan) {
					...
					Resource[] resources = (Resource[]) this.resourcePatternResolver.getResources(pattern);
