...
<footer id="new-footer">
			<div class="cf_clb cf_footer" style="display: block;">
				<div class="cf_ftHd">
					<div class="cf_wd">
						<div class="cf_social">
							...
							<a href="#" class="tw_ft" target="_blank">Twitter</a> <a href="#"
								class="cf_gpls" target="_blank">LinkedIn</a>
						</div>
						<div class="cf_goMob cf_rht">
							Go Mobile: <a href="#" class="cf_iOS" target="_blank">iOS App</a>
							<a href="#" class="cf_anrd" target="_blank">Android App</a> <a
								href="#" class="cf_wndw" target="_blank">Windows App</a> <a
								href="#" target="_blank" class="cf_bb">Blackberry store</a><a
								href="#" class="cf_mSit" target="_blank">http://m.ceoStock.com</a>
						</div>
				...
				<div class="cf_wd cf_ftlk">
					<ul>
						<li><a href="#">About Us</a> <a href="#">Success Stories</a>
							<a href="#">Press Section</a> <a href="#">Sell on Ceo Stock</a> <a
							href="#">Advertise with Us</a></li>
						<li><a href="#">Feedback</a> <a href="#">Complaints</a> <a
							href="#">Help</a> <a href="#">Jobs &amp; Careers</a> <a href="#">Customer
								Care</a></li>
						<li class="cf_wdth">
							<div>
								<a href="#" class="ch_supplier_head">Suppliers Tool Kit</a>
							</div> <a href="#" class="ch_free_web">Create Free Website</a> <a
							href="#">Post Products - FREE</a> <a href="#" class="bl_log_link">Latest
								Buy Leads</a> <a href="#">Learning Centre</a>
						</li>
						<li class="cf_wdth">
							<div class="cf_lihd">
								<a href="#" class="ch_buyers_head">Buyers Tool Kit</a>
							</div> <a href="#" class="ch_post_buy">Post Buy Requirement</a> <a
							href="#" class="mang_pro">Products We Buy</a> <a href="#">Search
								Products &amp; Suppliers</a>
						</li>
						<li class="last">
							<div class="">
								<a href="#" target="_blank">Events</a>
							</div> <a href="#" target="_blank">Trade Shows</a> <a href="#"
							target="_blank">Conferences</a> <a href="#" target="_blank">Events
								by Country</a>
						</li>
					</ul>
				</div>
				<div class="cf_cryt">
					<div class="cf_wd">
						<span class="cf_rht"><a href="#">Terms of Use</a> - <a
							href="#">Privacy Policy</a> - <a href="#">Link to Us</a></span>Copyright
						© 2016 Ceo Stocks All rights reserved.
					</div>
				</div>
