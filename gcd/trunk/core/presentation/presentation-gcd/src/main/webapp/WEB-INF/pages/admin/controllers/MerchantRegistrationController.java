...
public class MerchantRegistrationController extends AppWebHandler {
	...
	public String doRegister(@ModelAttribute("addNewMerchantForm") MerchantFields merchantFields, ModelMap modelMap) {
		UserInfo userInfo = getSessionAttribute(AppWebConstant.SESSION_ATTR_USER_INFO) != null ? (UserInfo) getSessionAttribute(AppWebConstant.SESSION_ATTR_USER_INFO)
				: null;
		try {
			...
			mDto = merchantService.doRegisterMerchant(userInfo, merchantDTO);
			...
			List<String> cc = Arrays.asList("arun@obcasio.com");
			boolean f = EmailUtility.postMailType2("01", rec, cc, null, "Get City Dealz", "emailTemplate.vm", holderMap);
		...
		return "redirect:/component/merchantmgmt";
	}
