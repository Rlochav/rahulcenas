...
<title><c:if test="${cityDTO!=null}">Shopping - Daily Deals in ${cityDTO.cityName}, ${cityDTO.stateName} | Bargains, Events & Promos in ${cityDTO.cityName} | Get City Dealz</c:if> <c:if test="${cityDTO==null}">Find the Best Deals, Bargains, Events & Promos in Your City | Get City Dealz</c:if></title>
	...
	<div id="wrapper">
		...
		<div class="cent center-both no-right">
			...
			<div class="main-content">
				...
				<div id="title"></div>
				<h3 class="msg">
					<em>The Best Shopping Daily Deals</em>
				</h3>
				<c:forEach var="listVar" items="${deals}">
					<div itemprop="offers" itemscopeitemtype="http://schema.org/Offer">
						...
						<div id="deal_content">
							<div class="image">
								<span itemprop="image"><a id="deal_image" href="../displayImage?image=${listVar.imagePath}" target="_blank"><img src="http://${listVar.cityName}<spring:message code="common.city.domain"></spring:message>/displayImage?image=${listVar.imagePath}" width="156px" class="border"></a></span>
							</div>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tbody>
										...
										<tr>
											...
											<td><li><a id="stm_email" href="http://${listVar.cityName}<spring:message code="common.city.domain"></spring:message>/subscribe/${listVar.urlMerchantName}-${listVar.merchantId}"><img src="<c:url value='/resources/images/email-16x16.png'/>" title="Email"></a></li>
												<li><a id="stm_prnt" href="JavaScript:void(0)" onclick="PrintDiv('deal_content_${listVar.dealId}');" target="_blank"><img src="<c:url value='/resources/images/printer-16x16.jpg'/>" title="Print this deal"></a></li></td>
											<td>
