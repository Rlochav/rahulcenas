			...
			<div class="custom">
				<div id="top_nav_buttons">
					<%-- <a id="tnb_dining" href="../dealsbymaincategory/dining"><img src="<c:url value='/resources/images/DINING.png'/>" border="0" alt="DINING" title="DINING"></a> <a id="tnb_nightlife" href="../dealsbymaincategory/night-life"><img src="<c:url value='/resources/images/NIGHTLIFE.png'/>"
						border="0" alt="NIGHTLIFE" title="NIGHTLIFE"> </a> <a id="tnb_shopping" href="../dealsbymaincategory/shopping"> <img src="<c:url value='/resources/images/SHOPPING.png'/>" border="0" alt="SHOPPING" title="SHOPPING"></a> <a id="tnb_attractions" href="../dealsbymaincategory/attractions">
