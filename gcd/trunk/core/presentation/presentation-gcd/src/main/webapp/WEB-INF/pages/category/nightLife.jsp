...
<title><c:if test="${cityDTO!=null}">Night Life - Daily Deals in ${cityDTO.cityName}, ${cityDTO.stateName} | Bargains, Events & Promos in ${cityDTO.cityName} | Get City Dealzs</c:if> <c:if test="${cityDTO==null}">Find the Best Deals, Bargains, Events & Promos in Your City | Get City Dealz</c:if></title>
	...
	<div id="wrapper">
		...
		<div class="cent center-both no-right">
			...
			<div class="main-content">
				...
				<div id="title"></div>
				<h3 class="msg">
					<em>The Best Night Life Daily Deals</em>
				</h3>
							...
							<div class="deal-content">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tbody>
										...
										<tr>
											<%-- <td colspan="3"><strong>Deal Code :</strong> <c:out value="${listVar.dealCode}" /></td> --%>
