			...
			<div class="middle-comtaner">
				...
				<div class="mid">
					<div class="mid-title text-padding">
						<div id="title">About Get City Dealz</div>
					</div>
					<div class="main-content text-padding-top">
						<div id="midContentDiv" class="item-page">
							<div id="system-message-container"></div>
							<h4>For Visitors:</h4>
							<p>Get City Dealz is a social deals site where you don't have to buy any kind of "coupon"! &nbsp;Our local merchants put up their latest and greatest deals that they have and all you have to do is head on into their establishments and take them up on the deal. &nbsp;Its that simple!</p>
							<p>You can search for deals by neighborhood, category or by our&nbsp;convenient&nbsp;map. &nbsp;You can also check out the merchant's profile for other news or events the merchant might post beyond their deals, as well as menus, hours of operation and ways to subscribe to get their latest
								deals or connect to them on other social sites. &nbsp;Get City Dealz also lets you rate the deals that merchants put out on the site so that way they'll know what visitors like.</p>
							<h4>For Merchants.</h4>
							<p>We offer an affordable way for our merchants to advertise their latest deals and drive foot traffic in a much more timely and&nbsp;efficient&nbsp;manner. &nbsp;We know that every dollar counts in today's economy so Get City Dealz doesn't ask you to discount anything by 50-75%, you
								decide the deal, you control the marketing message and you control when they deal runs.</p>
						</div>
						<div class="clr"></div>
					</div>
