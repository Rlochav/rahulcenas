...
<title><c:if test="${cityDTO!=null}">Dining - Daily Deals in ${cityDTO.cityName}, ${cityDTO.stateName} | Bargains, Events & Promos in ${cityDTO.cityName} | Get City Dealzs
	...
	<div id="wrapper">
		...
		<div class="cent center-both no-right">
			...
			<div class="main-content">
				...
				<div id="title"></div>
				<h3 class="msg">
					<em>The Best Dining Daily Deals</em>
				</h3>
