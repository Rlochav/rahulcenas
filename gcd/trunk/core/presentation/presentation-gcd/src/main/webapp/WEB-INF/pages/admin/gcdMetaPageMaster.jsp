		...
		<div class="cent  no-right">
			<div class="main-content">
				...
				<div id="dashboard-area">
					<div id="title">Add Page</div>
					<br>
						<div align="right">
							<a href="component/adminDashboard" class="link1">Return to Main Dashboard</a> &nbsp;<a href="component/gcd-meta-handler" class="link1">Return to meta manager</a> &nbsp;&nbsp;<a href="component/pageList" class="link1">Return to page list</a> &nbsp;
						</div> <br>
							<h3 class="msg">
								...
								<div class="profile">
									<table class="tableStyle" style="width: 100%;">
										<form:hidden path="id" />
										<tr>
											<td><strong>http://gcddev.com/common/</strong><span id="urls"></span> <form:input path="url" cssClass="mInput" cssStyle="width: 82.58%;" /></td>
										</tr>
										<tr>
											<td><form:input path="pageTitle" cssClass="mInput" cssStyle="width: 100%;" /></td>
										</tr>
										<tr>
											<td><form:textarea path="pageText" cols="50" rows="10" /> <ckfinder:setupCKEditor basePath="http://gcddev.com/resources/ckfinder/" editor="pageText" /> <ckeditor:replace replace="pageText" basePath="http://gcddev.com/resources/ckeditor/" /> <%--  --%></td>
										</tr>
										<tr>
...
<script type="text/javascript">
	$(function() {
		...
		if ("${metaDTO.url}" != "") {
			$("#urls").append('<strong>${metaDTO.url}</strong>');
			$("#url").hide();
		}
		$("#url").attr('placeholder', 'URL');
		$("#pageTitle").attr('placeholder', 'Page Title');
	});
	function createPosts() {
		if (trimString($("#url").val()) == "") {
			appFocus($("#url"));
			$.alert.open('error', 'Url is Mandatory.');
			return false;
		}
		...
		document.createPostForm.action = 'savePageMaster';
