			...
			<div class="middle-comtaner">
				...
				<div class="mid">
					<div class="mid-title text-padding">
						<div id="title">EMPLOYMENT</div>
					</div>
					<div class="main-content text-padding-top">
						<div id="midContentDiv" class="item-page">
							<div id="system-message-container"></div>
							<p>Currently we do not have any openings available at Get City Dealz however check back in the future for our employment opportunities.</p>
						</div>
						<div class="clr"></div>
					</div>
