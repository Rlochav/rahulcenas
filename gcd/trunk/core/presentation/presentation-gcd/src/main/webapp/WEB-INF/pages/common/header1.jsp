			...
			<div class="custom">
				<div id="top_nav_buttons">
					<%-- <a id="tnb_dining" href="${subdomainUrl}/dealsbymaincategory/dining"><img src="<c:url value='/resources/images/DINING.png'/>" border="0" alt="DINING" title="DINING"></a> <a id="tnb_nightlife" href="${subdomainUrl}/dealsbymaincategory/night-life"><img
						src="<c:url value='/resources/images/NIGHTLIFE.png'/>" border="0" alt="NIGHTLIFE" title="NIGHTLIFE"> </a> <a id="tnb_shopping" href="${subdomainUrl}/dealsbymaincategory/shopping"> <img src="<c:url value='/resources/images/SHOPPING.png'/>" border="0" alt="SHOPPING" title="SHOPPING"></a>
					<a id="tnb_attractions" href="${subdomainUrl}/dealsbymaincategory/attractions"> <img src="<c:url value='/resources/images/ATTRACTIONS.png'/>" border="0" alt="ATTRACTIONS" title="ATTRACTIONS"></a> <a id="tnb_services" href="${subdomainUrl}/dealsbymaincategory/services"> <img
