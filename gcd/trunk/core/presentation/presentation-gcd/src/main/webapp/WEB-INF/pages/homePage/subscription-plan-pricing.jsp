			...
			<div class="middle-comtaner">
				...
				<div class="mid">
					<div class="mid-title text-padding">
						<div id="title">SUBSCRIPTION PRICING</div>
					</div>
					<div class="main-content text-padding-top">
						<div id="midContentDiv" class="item-page">
							<div id="system-message-container"></div>
							<h3>Get City Dealz Basic Plan</h3>
							<p>Includes the ability to post 1 deal in a 24 hour period. &nbsp;Connection to from your Get City Dealz account to your social profiles to promote deals. &nbsp;Uploading ability of items like menus, pricing sheets, copouns and documents your customers can utlitize. &nbsp;Uploading of
								logos and icons. &nbsp;Blogging ability.</p>
							<ul>
								<li>Monthly: $300*

									<p style="padding: 10px 60px;">
										<em>*Three month minimum</em>
									</p>
								</li>

								<li>Yearly: $3000 (17% Discount) – Basically 2 Months Free!</li>
							</ul>
							<h3>Get City Dealz Plus Plan</h3>
							<p>Includes the ability to post up to 5 deals in a 24 hour period. &nbsp; Connection to from your Get City Dealz account to your social profiles to promote deals&nbsp;. &nbsp;Uploading ability of items like menus, pricing sheets, copouns and documents your customers can utlitize.
								&nbsp;Uploading of logos and icons. &nbsp;Blogging ability.</p>
							<ul>
								<li>Monthly: $350*
								...
								<li>Yearly: $3500 (17% Discount) – Basically 2 months free!</li>
							</ul>
						</div>
					</div>
					<div class="clr"></div>
