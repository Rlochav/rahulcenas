				...
				<div class="upper-header">
					<div class="social">
						<ul class="social-icon">
							...
							<li><a id="gcd_sm_pinterest" href="http://www.pinterest.com/getcitydealz"> <img src="<c:url value='resources/images/pintrest.png'/>" border="0" alt="pintrest" title="pintrest"></a></li>
							<li><a id="gcd_sm_g+" href="https://plus.google.com/113127686225602648376"> <img src="<c:url value='resources/images/gplush.png'/>" border="0" alt="Google Plus" title="Google Plus"></a></li>
							<li><a id="gcd_sm_youtube" href="http://www.youtube.com/user/GetCityDealz"> <img src="<c:url value='resources/images/youtube.png'/>" border="0" alt="youtube" title="youtube"></a></li>
							<div class="clr"></div>
						</ul>
							...
							<div class="main-content">
								...
								<div id="xmap">
									...
									<ul class="level_0">
										...
										<li><a href="about-get-city-dealz" title="About Get City Dealz">About Get City Dealz</a></li>
										<li><a href="become-a-merchant" title="Become a Merchant">Become a Merchant</a>
											<ul class="level_1">
												<li><a href="become-a-merchant/subscription-plan-pricing" title="Subscription Plan Pricing">Subscription Plan Pricing</a></li>
												<li><a href="become-a-merchant/secure-order-page" title="Secure Order Page">Secure Order Page</a></li>
												<li><a href="become-a-merchant/refund-policy" title="Refund Policy">Refund Policy</a></li>
											</ul></li>
										<li><a href="employment" title="Employment">Employment</a></li>
										<li><a href="merchant-login-city" title="Merchant Login">Merchant Login</a></li>
										<li><a href="subscribe" title="Get Our Deals">Get Our Deals</a></li>
										<li><a href="blogs" title="Blog">Blog</a></li>
										<li><a href="jefferson-chamber" title="Jefferson Chamber Special">Jefferson Chamber Special</a></li>
										<li><a href="new-orleans-merchant-listing" title="Merchant Listing">Merchant Listing</a></li>
									</ul>
				...
				<div class="right">
					...
					<div class="moduletable-deli">
						...
						<div class="custom-deli">
							<p style="text-align: center;">
								<a id="dd_email" href="subscribe" style="cursor: se-resize !important;"><img src="<c:url value='resources/images/email-24x24.png'/>" border="0" alt="Delivered By Email" title="Delivered By Email"></a>&nbsp; &nbsp;&nbsp;<a id="dd_fb" href="http://www.facebook.com/GetCityDealz"
									style="cursor: se-resize !important;" target="_blank"><img src="<c:url value='resources/images/facebook-24x24.png'/>" border="0" alt="Delivered on Facebook" title="Delivered on Facebook"></a>&nbsp; &nbsp; <a id="dd_twitter" href="https://www.twitter.com/GetCityDealz"
									style="cursor: se-resize !important;" target="_blank"><img src="<c:url value='resources/images/twitter-24x24.png'/>" border="0" alt="Delivered on Twitter" title="Delivered on Twitter"></a>
							</p>
						</div>
						<div class="ppanelf7">
							<p style="text-align: center;">
								<a id="dd_email" href="#"><img src="<c:url value='resources/images/email-24x24.png'/>" border="0" alt="Delivered By Email" title="Delivered By Email"></a>&nbsp; &nbsp;&nbsp;<a id="dd_fb" href="http://www.facebook.com/GetCityDealz" target="_blank"><img
									src="<c:url value='resources/images/facebook-24x24.png'/>" border="0" alt="Delivered on Facebook" title="Delivered on Facebook"></a>&nbsp; &nbsp; <a id="dd_twitter" href="https://www.twitter.com/GetCityDealz" target="_blank"><img
					...
					<div class="moduletable-deli">
						...
						<div class="custom-deli">
							<p align="center">
								<a href="http://www.facebook.com/GetCityDealz"><img src="<c:url value='resources/images/fb-like-button.png'/>" border="0" alt="Like Get City Dealz on Facebook"></a>
							</p>
							<p align="center">
								<a href="http://www.facebook.com/GetCityDealz" target="_blank">Like Us on&nbsp;Facebook&nbsp;&amp;&nbsp;Get Our Deals in Your News Feed</a>
							</p>
							<h3>
