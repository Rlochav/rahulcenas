...
public class MerchantDTO extends BaseDTO {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7778836425909002675L;
	...
	private String latestDealTitle;
	 ...
	 */
	public void setMerchantCategories(List<MerchantCategoryDTO> merchantCategories) {
	...
	/**
	 * @return the latestDealTitle
	 */
	public String getLatestDealTitle() {
		return latestDealTitle;
	}

	/**
	 * @param latestDealTitle
	 *            the latestDealTitle to set
	 */
	public void setLatestDealTitle(String latestDealTitle) {
		this.latestDealTitle = latestDealTitle;
	}

	/**
	 * @return the latestDealId
	 */
	...
	/**
	 * @param latestDealId
	 *            the latestDealId to set
	 */
	public void setLatestDealId(String latestDealId) {
		this.latestDealId = latestDealId;
	}
	...
	/**
	 * @return the neighborhoodAddress
	 */
	...
	/**
	 * @param neighborhoodAddress
	 *            the neighborhoodAddress to set
	 */
	...
	/**
	 * @param neighborhoodCity
	 *            the neighborhoodCity to set
	 */
	...
	/**
	 * @param neighborhoodState
	 *            the neighborhoodState to set
	 */
	...
	/**
	 * @param neighborhoodZip
	 *            the neighborhoodZip to set
	 */
	...
	/**
	 * @return the neighborhoodText
	 */
	public String getNeighborhoodText() {
		return neighborhoodText;
	}

	/**
	 * @param neighborhoodText the neighborhoodText to set
	 */
	public void setNeighborhoodText(String neighborhoodText) {
		this.neighborhoodText = neighborhoodText;
	}
